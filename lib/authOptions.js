...
// La bibliothèque 'uuid' n'est plus nécessaire si Prisma gère les UUID via @default(uuid())
    ...
    CredentialsProvider({
      ...
      async authorize(credentials) {
        if (!credentials?.email || !credentials?.password) {
          return null; // Données d'identification manquantes
        }
        ...
        // Si l'utilisateur vient d'OAuth, son champ password pourrait être vide ou un hash aléatoire.
